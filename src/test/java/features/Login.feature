Feature: Validate Login To Application and Edit the account
  ...
  Scenario Outline: Validate the message of Login page
    ...
    Examples: 
      ...
      | TC_01 | Login to Application | Returning Customer | northsee24@mailinator.com | Testbesttest@20 | Email field is required. | The Password field is required. |
